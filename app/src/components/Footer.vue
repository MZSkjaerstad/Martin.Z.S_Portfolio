<template>
  <footer class="footer">
    <svg class="footer__logo" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 164.5 199.4" style="enable-background:new 0 0 164.5 199.4;" xml:space="preserve">
    ...
    <div class="footer__content">
      ...
      <div class="footer__link-wrapper">
        ...
        <div class="footer__link-button">
          <a
            class="footer__link"
            href="https://www.instagram.com/martin.z.s/"
            target="_blank"
            >Instagram</a
          >
        ...
        <div class="footer__link-button">
          <a
            class="footer__link"
            href="https://github.com/MZSkjaerstad"
            target="_blank"
            >Github</a
          >
      ...
      <div class="footer__link-wrapper">
        <div class="footer__link-button">
          <p class="footer__link">Oslo, Norway</p>
        ...
        <div class="footer__link-button">
          <a
            class="footer__link"
            href="mailto: Martskjae@hotmail.no"
            target="_blank"
            >Martskjae@hotmail.no</a
          >
